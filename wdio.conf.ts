...
export const config: Options.Testrunner = {
  ...
  //
  specs: ["./tests/**/Assessment.feature"],
  // Patterns to exclude.
  exclude: [
  ...
  // reporters: [
  //     'cucumberjs-json',
  //     ['cucumberjs-json', { jsonFolder: process.cwd() + "/Reports/json",
  //     language: 'en',
  //     },
  //     ],
  //     ],
  ...
  before: function () {
    ...
    //  EnvJSONPath = path.join(userDirPath, "/Resources/JsonFiles/Enviroinment.json");

    globalThis.EnvJSONPath = path.join(
      userDirPath,
      "/resources/jsonfiles/Enviroinment.json"
    );

    globalThis.RegJSONPath = path.join(
      userDirPath,
      "/resources/jsonFiles/Registration.json"
    );
  ...
  //       // Take a screenshot on step failure and attach it to the Allure report
  //       const screenshot = browser.takeScreenshot();
  //       AllureReporter.addAttachment('Screenshot after step failure', screenshot, 'image/png');
  ...
  onComplete: () => {
    ...
    generate({
      ...
      // default = '.tmp/json/'
      jsonDir: ".tmp/json/",
      reportPath: `Reports/report_${date}_${time.trim()}`,
      //   reportPath: path.join('Reports/Testreport_${date}', date,time),
